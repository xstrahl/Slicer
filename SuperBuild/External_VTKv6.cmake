...
if((NOT DEFINED VTK_DIR OR NOT DEFINED VTK_SOURCE_DIR) AND NOT ${CMAKE_PROJECT_NAME}_USE_SYSTEM_${proj})
  ...
  set(${CMAKE_PROJECT_NAME}_${proj}_GIT_REPOSITORY "github.com/xstrahl/VTK.git" CACHE STRING "Repository from which to get VTK" FORCE)
  set(${CMAKE_PROJECT_NAME}_${proj}_GIT_TAG "196ce0b0a5bb5a0e4d0a5bca970318434266135f" CACHE STRING "VTK git tag to use" FORCE)
